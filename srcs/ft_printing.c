...
/*   Updated: 2023/05/09 10:55:07 by mjuin            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_y_lines(mlx_image_t *img, t_bresenham *bre, int color)
{
	...
	while (i <= bre->dy)
	{
		if (bre->pos1.x > -1 && bre->pos1.x < HEIGHT
...
void	ft_print_lines_v3(mlx_image_t *img, int x, int start, int end, int c)
{
	t_bresenham		*bre;
